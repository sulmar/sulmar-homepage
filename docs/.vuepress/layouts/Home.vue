    ...
    <GlobalLayout>
        <div class="home-custom">
            ...
            <section class="hero">
                ...
                <v-btn rounded="xl" size="large" variant="outlined" @click="scrollToSection('#courses')"
                    class="hero-btn">Zamów
                    szkolenie</v-btn>
            </section>
            ...
            <section id="courses" class="courses">
                ...
                <v-container class="container">
                    ...
                    <header>
                        <p class="sm-title">Najczęście wybierane szkolenia</p>
                        <h2>Szlifuj swoje umiejętności programistyczne</h2>
                        <p> Dzięki naszym kursom Twój zespół będzie wymiatał. Do tego szkolenie będzie bez powerpointa.
                            Cenna
                    ...
                    <v-row>
                        ...
                        <v-col>
                            ...
                            <div class="trainer-description">
                                <p>Wykształcenie: mgr informatyki Absolwent Uniwersytet A. Mickiewicza w Poznaniu,
                                    Wydział
                                    Matematyki i
                                    Informatyki Doświadczenie: 20+ lat Rozwiązania m.in. dla logistyki, monitoringu
                                    pojazdów
                                    z użyciem .NET i
                                    Crystal Reports. Tworzę rozwiązania dla swoich klientów a zdobytym doświadczeniem
                                    dzielę
                                    się na
                                    szkoleniach.
                                </p>
            ...
            <section id="contact" class="cta-section">
                ...
                <v-container class="cta-content">
                    <div class="cta-description">
                        ...
                        <p>Napisz do nas, aby omówić szkolenie dla Twojej firmy. Daj nam znać, czego potrzebuje Twój
                            zespół
                            i w jaki
                            sposób możemy Ci pomóc w osiągnięciu celów.</p>
                    </div>
